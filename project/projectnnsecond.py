...
model_ann2nd.add(layers.Dense(128, activation='relu', input_shape=(28 * 28,)))
model_ann2nd.add(layers.Dense(64, activation='relu'))
...
model_ann2nd.fit(X_train, y_train_encoded, epochs=50, batch_size=128, validation_data=(X_val, y_val_encoded))

# Evaluate The ANN model on the validation set
y_val_pred_probs = model_ann2nd.predict(X_val)
y_val_pred = np.argmax(y_val_pred_probs, axis=1)
